...
var _ListItem = require('../list/ListItem.js');
...
var factory = function factory(ListItem) {
  var FlexList = function (_Component) {
    ...
    function FlexList() {
      ...
      return _possibleConstructorReturn(this, Object.getPrototypeOf(FlexList).apply(this, arguments));
    }
    ...
    _createClass(FlexList, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          'ul',
          { 'data-react-toolbox': 'flexlist', className: (0, _classnames2.default)([theme.flexlist, theme[align]], this.props.className) },
          this.renderItems()
        );
      }
    }]);
