  ...
  var BottomSheet = function (_Component) {
    ...
    _createClass(BottomSheet, [{
      ...
      value: function render() {
        ...
        var className = (0, _classnames3.default)([theme.bottomsheet, theme[type]], _defineProperty({}, theme.active, active), this.props.className);
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: theme.bottomsheet__item },
              children
            ),
